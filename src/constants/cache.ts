...
export function buildTimestampedCachePayload<TData>(data: TData, timestamp: number = Date.now()): TimestampedCachePayload<TData> {
    return { timestamp, data };
}

export function isValidTimestampedRecordCachePayload(value: unknown): value is TimestampedCachePayload<Record<string, any>> {
